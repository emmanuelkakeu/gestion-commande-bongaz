...
public class UsersServiceImpl implements UsersService {
    ...
    public UsersDto save(UsersDto dto) {
        ...
        return UsersDto.fromEntity(
                usersRepository.save(
                        UsersDto.toEntity(dto)
                )
        );
    }

    private boolean userAlreadyExists(String email) {
        Optional<Users> user = usersRepository.findUtilisateurByEmail(email);
    ...
    @Override
    public UsersDto changerMotDePasse(ChangerMotDePasseUtilisateurDto dto) {
        validate(dto);
        ...
        Users users = utilisateurOptional.get();
